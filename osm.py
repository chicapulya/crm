...
from config import BBOX, DB_PATH
from text_norm import norm, similarity
...
SECTOR_CACHE  = Path(__file__).parent / "osm_sectors.json"
...
_PARTIAL = Path(__file__).parent / "osm_cache_partial.json"
